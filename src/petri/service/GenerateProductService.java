...
public class GenerateProductService {
    ...
    public PetriNet getProductOfEventNetAndProcessNet(PetriNet eventNet, PetriNet processNet) {
        ...
        //初始化product变迁数组
        ArrayList<TransitionOfCompositionModel> topArray = new ArrayList<>();
        ...
        int tnum = eventNet.tnum + syncTnum + processNet.tnum;
        ...
        //初始化关联矩阵中的process变迁列
        for (i = 0, k = syncTnum + eventNet.tnum; i < processNet.tnum; ++i) {
        ...
        return new PetriNet(array, pnum, tnum, ic, fc, topArray, placeIndex, end - start);
    }
}
